...
<table>
	<tr>
		<th>ПРОДУКТ</th> <th>ЦЕНА</th> <th>СКИДКА</th> <th>СКИДКА ОТ ОБЪЁМА</th>
		<th>СУММАРНАЯ СКИДКА</th> <th>СТОИМОСТЬ СО СКИДКОЙ</th> <th>КОЛИЧЕСТВО</th>
		<th>В НАЛИЧИИ</th> <th>СУММА</th>
	</tr>';
	for ($i = 0; $i < count($prod); $i++) {
		echo'<tr>
			   <td>'.$prod[$i].'</td>
			   ...
			   <td>'.$quantity[$i].' <i>шт.</i><br><span>'.$not_available[$i].'</span></td>
	...
	<tfoot>
	  <tr>
		<td colspan="8"><br>Итого:<br>
			...
			Всего наименований: '.count($prod).'<br>
